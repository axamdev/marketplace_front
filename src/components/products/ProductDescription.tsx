  ...
  return (
    <Box>
      <H3 mb={2}>Specification:</H3>
        ...
        Fragrance Description: This is a delicious potion of joy built around the gardenia flower blended with solar jasmine absolute, cheerful pear blossom accord, and sweet brown sugar accord. It is a signature floral scent for all free-spirited women full of positive energy
      </Box>
